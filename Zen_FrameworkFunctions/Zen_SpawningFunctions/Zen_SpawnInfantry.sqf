...
private ["_spawnPos", "_side", "_skill", "_group", "_soldierlistrand", "_c", "_spawnNumber", "_cMin", "_cMax", "_soldierlist", "_menType", "_faction", "_filterTypes", "_i"];
...
_soldierlist = [_menType, _side, "All", _faction] call Zen_ConfigGetVehicleClasses;

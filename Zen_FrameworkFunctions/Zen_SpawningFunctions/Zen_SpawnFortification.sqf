...
private ["_center", "_distance", "_i", "_noMG", "_class", "_distanceError", "_spawnPos", "_direction", "_object", "_mgSpawnPos", "_box", "_size2d", "_phi"];
...
while {_i < 352} do {
    ...
    if (_noMG && [_class, "Land_BagFence_Long_F"] call Zen_ValuesAreEqual) then {
        ...
        0 = [_mgSpawnPos, "B_HMG_01_high_F", 0, _direction, true] call Zen_SpawnVehicle;
    };

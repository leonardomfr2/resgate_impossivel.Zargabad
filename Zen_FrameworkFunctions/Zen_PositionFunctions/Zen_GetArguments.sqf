...
private ["_water", "_areaAvoid", "_road", "_roadID", "_roadDist", "_area", "_min", "_max", "_Vars", "_maxAngle", "_minAngle", "_angles", "_objSwitch", "_objLimit", "_objDist", "_objects", "_Trig", "_minMax", "_pointAvoid", "_pointAvoidSwitch", "_pointAvoidArray", "_pointAvoidDist", "_nearWater", "_nearWaterSwitch", "_nearWaterDist", "_terrainSlopeSwitch", "_terrainSlopeAngle", "_terrainSlope", "_ambientClutterSwitch", "_ambientClutterCount", "_ambientClutterRadius", "_ambientClutter", "_height", "_heightSwitch", "_heightNumber", "_heightRadius"];

if !([_this, [["VOID"], ["ARRAY", "SCALAR"], ["ARRAY", "SCALAR"], ["SCALAR"], ["ARRAY", "SCALAR"], ["ARRAY", "SCALAR"], ["ARRAY", "SCALAR"], ["ARRAY", "SCALAR"], ["ARRAY", "SCALAR"], ["ARRAY", "SCALAR"], ["ARRAY", "SCALAR"], ["ARRAY", "SCALAR"], ["ARRAY", "SCALAR"]], [[], ["SCALAR"], ["STRING"], [], ["SCALAR"], ["SCALAR", "STRING"], ["SCALAR"], ["SCALAR", "ARRAY", "OBJECT", "GROUP", "STRING"], ["SCALAR"], ["SCALAR"], ["SCALAR", "ARRAY"], ["SCALAR"]], 1] call Zen_CheckArguments) exitWith {
...
(if (typeName _area == "STRING") then {
    ([_area, _min, _areaAvoid, _water, _roadID, _roadDist, _minAngle, _maxAngle,_objSwitch,_objLimit,_objDist,_pointAvoidSwitch,_pointAvoidArray,_pointAvoidDist,_nearWaterSwitch,_nearWaterDist, _terrainSlopeSwitch, _terrainSlopeAngle, _ambientClutterSwitch, _ambientClutterCount, _ambientClutterRadius, _heightSwitch, _heightNumber, _heightRadius])
} else {
    ([([_area] call Zen_ConvertToPosition), _min, _max, _areaAvoid, _water, _roadID, _roadDist, _minAngle, _maxAngle,_objSwitch,_objLimit,_objDist,_pointAvoidSwitch,_pointAvoidArray,_pointAvoidDist,_nearWaterSwitch,_nearWaterDist, _terrainSlopeSwitch, _terrainSlopeAngle, _ambientClutterSwitch, _ambientClutterCount, _ambientClutterRadius, _heightSwitch, _heightNumber, _heightRadius])
})
